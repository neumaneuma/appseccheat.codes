...
# Block public access (CloudFront will be used to serve content)
...
# Not strictly necessary since all the files are publicly accessible via
# CloudFront, but good practice nonetheless
