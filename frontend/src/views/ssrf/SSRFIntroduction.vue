<template>
  <div class="ssrf-introduction">
    <p>
      ...
      <span class="code-block">127.0.0.1</span>), requests to an internal admin API, or requests that use
      the <span class="code-block">file://</span> schema to access internal files on the network.
    </p>
    <p>
      How might an attacker pull this off? They simply need a server endpoint that accepts a URL or an IP address as
      input. A <a href="https://en.wikipedia.org/wiki/Webhook" target="_blank" rel="noopener" class="wiki-link">webhook</a> is a common feature these days
